package com.alearner.common.util;
...
import com.alearner.common.annotation.ExportConfig;
import com.alearner.common.handler.ExportHandler;
import com.alearner.common.util.poi.convert.ExportConvert;
import com.alearner.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
	...
	private void required$BuilderParams() {
		if (mClass == null) {
			throw new IllegalArgumentException("请先使用cc.alearner.util.ExcelUtils.$Builder(Class<?>)构造器初始化参数。");
		}
	}
	...
	private void required$ExportParams() {
		if (mClass == null || mResponse == null) {
			throw new IllegalArgumentException(
					"请先使用cc.alearner.util.ExcelUtils.$Export(Class<?>, HttpServletResponse)构造器初始化参数。");
		}
